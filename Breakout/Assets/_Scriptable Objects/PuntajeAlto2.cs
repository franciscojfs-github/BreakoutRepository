...
public class PuntajeAlto2 : ObjetoPersistente     // es de tipo ScriptableObject (quizas por eso el valor se queda guardado y no empieza de cero?). Se quito la palabra ScriptableObject y se agrego que hereda mas bien de ObjetoPersistente porque aquella es virtual
{
