...
public class PuntajeAlto : PuntajePersistente     // es de tipo ScriptableObject (quizas por eso el valor se queda guardado y no empieza de cero?). Se quito la palabra ScriptableObject y se agrego que hereda mas bien de PuntajePersistente porque aquella es virtual
{
